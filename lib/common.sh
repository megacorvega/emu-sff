...
DEFAULT_COMPOSITE_MARGIN_LEFT="24"
DEFAULT_COMPOSITE_MARGIN_RIGHT="24"
DEFAULT_COMPOSITE_MARGIN_TOP="16"
DEFAULT_COMPOSITE_MARGIN_BOTTOM="16"
...
save_state_file() {
...

    {
        ...
        printf 'COMPOSITE_MARGIN_LEFT=%q\n' "${COMPOSITE_MARGIN_LEFT:-${DEFAULT_COMPOSITE_MARGIN_LEFT}}"
        printf 'COMPOSITE_MARGIN_RIGHT=%q\n' "${COMPOSITE_MARGIN_RIGHT:-${DEFAULT_COMPOSITE_MARGIN_RIGHT}}"
        printf 'COMPOSITE_MARGIN_TOP=%q\n' "${COMPOSITE_MARGIN_TOP:-${DEFAULT_COMPOSITE_MARGIN_TOP}}"
        printf 'COMPOSITE_MARGIN_BOTTOM=%q\n' "${COMPOSITE_MARGIN_BOTTOM:-${DEFAULT_COMPOSITE_MARGIN_BOTTOM}}"
